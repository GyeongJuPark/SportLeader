...
namespace SportLeader.Application.SportsLeader
{
  ...
  public class SportLeaderService : ISportLeaderService
  {
    ...
    public void Update(RegisterSportsLeaderRequest model)
    {
      ...
      public MappingProfile()
      {
        CreateMap<T_LeaderWorkInfo, LeaderInfoDto>()
            .ForMember(dest => dest.Histories, opt => opt.MapFrom(src => src.T_History.Select(history => new HistoryDto
            {
              ...
              SportsName = history.T_Sport.SportsName
            })))
            ...
            .ForMember(dest => dest.SportsNo, opt => opt.MapFrom(src => src.T_Sport.SportsNo))
            .ForMember(dest => dest.SportsName, opt => opt.MapFrom(src => src.T_Sport.SportsName))
            .ForMember(dest => dest.SchoolNo, opt => opt.MapFrom(src => src.T_School.SchoolNo))
